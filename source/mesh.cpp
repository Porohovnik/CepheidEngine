...
Mesh line_mesh(){
    Mesh_info info;
    info.elements_cout[static_cast<int>(TYPE_data::position)]=1;
    ...
    return Mesh(info,data);
};

Mesh plate_mesh(){
    //std::cout<<";2;"<<std::endl;
    Mesh_info info;
    info.elements_cout[static_cast<int>(TYPE_data::position)]=3;
    info.tex_cord_cout[0]=2;
