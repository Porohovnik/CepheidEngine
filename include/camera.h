...
public:
    ...
    void ProcessKeyboard(Camera_Movement direction, GLfloat deltaTime){
        ...
        switch (direction) {
            ...
            case DOUWN:   {this->Position -= this->Up    * velocity;};break;
        };
    }
...
//            this->Zoom = 90.0f;
    ...
    void new_frame(){
        view=GetViewMatrix();
        //projection=glm::perspective(glm::radians(Zoom), static_cast<GLfloat>(width) / static_cast<GLfloat>(height), 0.1f, 1000.0f);
    }
